...
export function TranslationTable({ tableName, title, description }: TranslationTableProps) {
  ...
  const fetchRecords = async () => {
    ...
    try {
      ...
      if (searchTerm) {
        query = query.ilike('szname', `%${searchTerm}%`)
      }
                  ...
                  {loading ? (
                    ...
                    records.map((record) => (
                      <TableRow key={record.szname}>
                        <TableCell className="font-medium">{record.szname}</TableCell>
                        {LANGUAGES.map((lang) => (
                          <TableCell key={lang.code} className="max-w-32">
                            <div className="truncate" title={getLanguageValue(record, lang.code)}>
                        ...
                        <TableCell>
                          <div className="flex gap-2">
                            ...
                            <Button variant="outline" size="sm" onClick={() => handleDelete(record.szname)}>
